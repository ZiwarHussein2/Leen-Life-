...
exports.DEPARTMENT_SCOPED_ROLES = exports.MFA_REQUIRED_ROLES = exports.ROLE_PERMISSIONS = exports.ROLES = exports.PERMISSIONS = void 0;
...
const ALL_PERMISSIONS = Object.keys(exports.PERMISSIONS);
/**
 ...
 */
exports.DEPARTMENT_SCOPED_ROLES = ["DEPARTMENT_OPERATOR", "SONAR_DOCTOR"];
function isDepartmentScoped(role) {
    return exports.DEPARTMENT_SCOPED_ROLES.includes(role);
}
